# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2019-01-18 05:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_type', models.SmallIntegerField(choices=[(0, '付费'), (1, 'VIP专享'), (2, '学位课')], default=0)),
                ('brief', models.TextField(blank=True, max_length=2048, verbose_name='课程（模块）概述')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_slogon', models.CharField(blank=True, max_length=125, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('time_percent', models.PositiveIntegerField(help_text='只填百分值，如80，代表80%', verbose_name='奖励档位（时间百分比）')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.SmallIntegerField(choices=[(0, '讲师'), (1, '导师')], default=0, verbose_name='角色')),
